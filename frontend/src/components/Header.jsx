...
export default function Header({ onCreateTask, onViewAllHistory }) {
  return (
    <div className="flex items-center justify-between mb-8">
      <div>
        <h1 className="text-5xl font-bold bg-gradient-to-l from-gray-600 to-black bg-clip-text text-transparent flex items-center gap-3">
       Kanban AI
        </h1>
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-gray-600 to-black text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 font-medium shadow-lg hover:shadow-xl transition-all"
        >
